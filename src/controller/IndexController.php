...
use Silex\Application;
    ...
    class IndexController extends Controller{
        ...
        $email = htmlspecialchars(trim($request->request->get["email"])); // Modification des balises html
        $password = strip_tags(trim($request->request->get["password"])); // Suppression des balise html php
        $username = strip_tags(trim($request->request->get["username"])); // Suppression des balise html php
